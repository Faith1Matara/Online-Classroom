...
// Check if the instructor is already logged in, and redirect to the home page
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($email_err) && empty($password_err)) {
        ...
        $sql = "SELECT id, email, password FROM instructor WHERE email = ?";
        ...
        if ($stmt = mysqli_prepare($conn, $sql)) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                if (mysqli_stmt_num_rows($stmt) == 1) {
                    ...
                    mysqli_stmt_bind_result($stmt, $instructor_id, $email, $hashed_password);
                    if (mysqli_stmt_fetch($stmt)) {
                        if (password_verify($password, $hashed_password)) {
                            ...
                            $sql = "SELECT first_name FROM instructor WHERE email = ?";
                            ...
                            // Redirect instructor to home page
                            header('Location: ./instructor-dashboard.php');
                            exit();
                        } else {
                            ...
                            <div class="container page__container">
                                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <p class="text-right"><a href="instructor-code-reset.php"
