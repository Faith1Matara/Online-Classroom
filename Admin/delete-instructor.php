...
if (isset($_POST['delete-instructor'])) {
    $sql = "DELETE FROM instructor WHERE id = '$instructor_id'";
                ...
                <div class="mdk-drawer-layout__content page-content">
                    ...
                    <div class="page-section">
                        <div class="container page__container">
                            ...
                            <button type="submit" name="delete-instructor" class="btn btn-primary">Delete</button>
                            </form>
                        </div>
                    </div>
