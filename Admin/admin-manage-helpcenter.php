                    ...
                    <div class="pt-32pt">
                        <div class="container page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
                            ...
                            <div class="row" role="tablist">
                                <div class="col-auto">
                                    <a href="./add-helpcenter.php" class="btn btn-outline-secondary">Add Help Content</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="page-section border-bottom-2">
                        <div class="container page__container">
                            <div class="page-separator">
                                <div class="page-separator__text">Help Questions</div>
                            </div>
                                    ...
                                    <table class="table mb-0 thead-border-top-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    <a href="javascript:void(0)" class="sort" data-sort="js-lists-values-first-name">Title</a>
                                                </th>
                                                <th>
                                                    <a href="javascript:void(0)" class="sort" data-sort="js-lists-values-last-name">Content</a>
                                                </th>
                                                <th>
                                                    <a href="javascript:void(0)" class="sort" data-sort="js-lists-values-email">Links</a>
                                                </th>
                                        ...
                                        <tbody class="list" id="leaves">
                                            ...
                                            ?>
                                                <tr>
                                                    <td class="pr-0">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input js-check-selected-row" id="customCheck<?php echo $row['help_id']; ?>">
                                                            <label class="custom-control-label" for="customCheck<?php echo $row['help_id']; ?>"><span class="text-hide">Check</span></label>
                                                        </div>
                                                    </td>
                                                    <td class="js-lists-values-first-name"><?php echo $row['title']; ?></td>
                                                    <td class="js-lists-values-last-name"><?php echo $row['content']; ?></td>
                                                    <td class="js-lists-values-email"><?php echo $row['link']; ?></td>
                                                    <td>
                                                        <a href="edit-helpcenter.php?id=<?php echo $row['help_id']; ?>" class="btn btn-secondary">Edit</a>
                                                    </td>
                                                    <td>
                                                        <a href="delete-helpcenter.php?id=<?php echo $row['help_id']; ?>" class="btn btn-danger">Delete</a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
