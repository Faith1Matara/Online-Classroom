...
<body class="layout-sticky layout-sticky-subnav ">
                    ...
                    <div class="page-section border-bottom-2">
                        <div class="container page__container">
                            ...
                            <div class="card mb-32pt">
                                ...
                                <div class="table-responsive d-none" id="instructor-table">
                                        ...
                                        <tbody class="list" id="leaves">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="js-lists-values-last-name"><?php echo $row['last_name']; ?></td>
                                                    <td class="js-lists-values-email"><?php echo $row['email']; ?></td>
                                                    <td class="js-lists-values-email"><?php echo $row['speciality']; ?></td>
                                                </tr>
                                            <?php
                                            }
                                            ?>
    ...
    <script>
        function printTable() {
            var printContents = document.getElementById('instructor-table').innerHTML;
