...
if (isset($_POST['add-help'])) {
    ...
    if (empty($title_err) && empty($content_err) && empty($link_err)) {
        ...
        $sql = "INSERT INTO helpcenter (title, content, link) VALUES ('$title', '$content', '$link')";
                ...
                <div class="mdk-drawer-layout__content page-content">
                    ...
                    <div class="page-section pb-0">
                        <div class="container page__container d-flex flex-column flex-sm-row align-items-sm-center">
                            <div class="flex">
                                <h1 class="h2 mb-0">Add Help</h1>
                                <p class="text-breadcrumb">Add help questions</p>
                            </div>
                            <p class="d-sm-none"></p>
                    ...
                    <div class="page-section">
                        <div class="container page__container">
                            <div class="page-separator">
                                <div class="page-separator__text">Add Help Content</div>
                            </div>
                            <form action="" method="post">
                                ...
                                <button type="submit" name="add-help" class="btn btn-primary">Save</button>
                            </form>
                        </div>
                    </div>
