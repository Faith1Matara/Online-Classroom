...
<body class="layout-sticky layout-sticky-subnav ">
                    ...
                    <div class="page-section border-bottom-2">
                        <div class="container page__container">
                            ...
                            <div class="card mb-32pt">
                                    ...
                                    <table class="table mb-0 thead-border-top-0 table-nowrap">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    <a href="javascript:void(0)" class="sort" data-sort="js-lists-values-first-name">Course Name</a>
                                                </th>
                                                <th style="width: 48px;" colspan="3" class="text-center">
                                                    ...
                                                    <td>
                                                        <form action="" method="POST">
                                                            ...
                                                            <?php if ($row['status'] == 'dropped') {
                                                                echo '<p class="btn btn-secondary">Dropped</p>';
                                                            } else { ?>
                                                                <input type="submit" name="approve" <?php if ($row['status'] == 'approved') {
                                ...
                                <div class="table-responsive p-3 d-none" id="courses-table">

                                    <table class="table mb-0 thead-border-top-0 table-nowrap p-3">
                                        <thead>
                                            <tr>
                                                <th>
                                                    Course Name
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        $get_instructor = mysqli_query($conn, "SELECT * FROM instructor WHERE id = '$i_id'");
    ...
    <script>
        function printTable() {
            var printContents = document.getElementById('courses-table').innerHTML;
