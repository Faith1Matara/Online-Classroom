...
if (isset($_POST['delete-help'])) {
    $sql = "DELETE FROM helpcenter WHERE help_id = '$help_id'";
                ...
                <div class="mdk-drawer-layout__content page-content">
                    ...
                    <div class="page-section pb-0">
                        <div class="container page__container d-flex flex-column flex-sm-row align-items-sm-center">
                            <div class="flex">
                                <h1 class="h2 mb-0">Delete Help</h1>
                                <p class="text-breadcrumb">Delete help questions</p>
                            </div>
                            <p class="d-sm-none"></p>
                    ...
                    <div class="page-section">
                        <div class="container page__container">
                            <div class="page-separator">
                                <div class="page-separator__text">Delete Help Content</div>
                            </div>
                            <form action="" method="post">
                                ...
                                <button type="submit" name="delete-help" class="btn btn-primary">Delete</button>
                            </form>
                        </div>
                    </div>
