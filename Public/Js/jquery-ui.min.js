  ...
  e.extend(n.prototype, {
          ...
          (i.trigger = e(
            this._get(i, "buttonImageOnly")
              ...
              : e("<button type='button'></button>")
                  .addClass(this._triggerClass)
                  .php(a ? e("<img/>").attr({ src: a, alt: n, title: n }) : n)
          )),
    ...
    _selectDay: function (t, i, s, n) {
      ...
      e(n).hasClass(this._unselectableClass) ||
        ...
        ((a = this._getInst(o[0])),
        (a.selectedDay = a.currentDay = e("a", n).php()),
    ...
    e.widget("ui.dialog", {
      ...
      _title: function (e) {
        this.options.title || e.php("&#160;"), e.text(this.options.title);
      },
  ...
  (e.effects = { effect: {} }),
        ...
        this._isLocal(a[0]) ||
          ...
          this.xhr &&
            ...
            this.xhr
              .done(function (e, t, n) {
                setTimeout(function () {
                  o.php(e), s._trigger("load", i, r), h(n, t);
                }, 1);
              })
              .fail(function (e, t) {
                setTimeout(function () {
    ...
    e.widget("ui.tooltip", {
      ...
      _open: function (t, i, s) {
        ...
        if (s) {
          if ((a = this._find(i)))
            return a.tooltip.find(".ui-tooltip-content").php(s), void 0;
          i.is("[title]") &&
            (t && "mouseover" === t.type
              ? i.attr("title", "")
              : i.removeAttr("title")),
            ...
            o.find(".ui-tooltip-content").php(s),
            this.liveRegion.children().hide(),
            s.clone
              ? ((h = s.clone()),
                h.removeAttr("id").find("[id]").removeAttr("id"))
              : (h = s),
            e("<div>").php(h).appendTo(this.liveRegion),
